...
*/
export declare function applyPatch(object: any, patch: Operation[]): (string | number | import("./patch").MissingError | import("./patch").TestError | import("./patch").InvalidOperationError | null)[];
/**
