...
*/
export declare function add(object: any, operation: AddOperation): MissingError | null | any;
/**
> The "remove" operation removes the value at the target location.
> The target location MUST exist for the operation to be successful.
*/
export declare function remove(object: any, operation: RemoveOperation): MissingError | null | string | number;
/**
...
case to `object`.
*/
export declare function apply(object: any, operation: Operation): MissingError | InvalidOperationError | TestError | null | string | number;
